...
export const Homefilled = ({ className }) => {
  return (
    ...
    >
      <g className="g" clipPath="url(#clip0_445_237)">
        <g className="g" filter="url(#filter0_d_445_237)">
      ...
      <defs className="defs">
        ...
        >
          ...
          />
          <feBlend className="fe-blend" in2="BackgroundImageFix" mode="normal" result="effect1_dropShadow_445_237" />
          <feBlend
            className="fe-blend"
            in="SourceGraphic"
            in2="effect1_dropShadow_445_237"
            mode="normal"
            result="shape"
          />
        </filter>
        <clipPath className="clip-path" id="clip0_445_237">
