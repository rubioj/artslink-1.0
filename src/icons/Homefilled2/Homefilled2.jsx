...
export const Homefilled2 = ({ className }) => {
  return (
    ...
    >
      <g className="g" clipPath="url(#clip0_445_253)">
        <g className="g" filter="url(#filter0_d_445_253)">
      ...
      <defs className="defs">
        ...
        >
          ...
          />
          <feBlend className="fe-blend" in2="BackgroundImageFix" mode="normal" result="effect1_dropShadow_445_253" />
          <feBlend
            className="fe-blend"
            in="SourceGraphic"
            in2="effect1_dropShadow_445_253"
            mode="normal"
            result="shape"
          />
        </filter>
        <clipPath className="clip-path" id="clip0_445_253">
